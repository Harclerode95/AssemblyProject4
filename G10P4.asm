...
;Paul MacLean, Mark Blatnik, Tyler Harclerode, DaNell Griffin
;January 19, 2018
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Tyler's Data Additions: ;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
buffer		BYTE DUP(80)
nodebuffer	BYTE DUP(6)

;Fixed Structure:
n_name			BYTE 0		;node name
n_numconnections	BYTE 0		;number of connections to other nodes
n_queue			DWORD 0		;address of current node's queue
n_input			DWORD 0		;queue of pointers of incoming packets (rcv)
n_output		DWORD 0		;queue of pointers of outgoing packets (xmt)
fixedoffset		EQU 14		;fixed structure offset

;Varying Structure:
n_conn_address	DWORD 0		;address to connection
n_conn_rcv	DWORD 0		;transmit pointer
n_conn_xmt	DWORD 0		;receive pointer
variableoffset 	EQU 12		;varying structure offset
...
main ENDP
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
createnode PROC		;ecx = #conn, ebx = namechar 

	MOV	n_name, ebx
	MOV	n_numconnections, ecx
